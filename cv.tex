...
%--------------------TITLE-------------
  ...
  \begin{tabular}{ p{11cm}r }
   \scshape{\Huge{Charles Nourry}} & \multirow{5}{1in}{\includegraphics[width=0.88in]{avatar}} \\
   \\
   \textsc{Age:} 21 ans &\\
    \textsc{Address:} 1 rue de la ferme &\\
    \textsc{Ville:} 78150 - Le Chesnay&\\
    \textsc{Phone:} 06 21 09 85 62&\\
    \textsc{email:} \email{nourry_charles@outlook.fr}&%\href{mailto:nourry_charles@outlook.fr}{nourry_charles@outlook.fr}&
  \end{tabular}
