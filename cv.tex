...
\section{Formation}
\begin{tabular}{p{0.1cm} c p{0.1cm}|p{12.5cm}}
...
\begin{tabular}{cl}	
 ...
 2016-2018 & Projets universitaires : Modélisation de problèmes de gestion, Opimisation de la résolution de puzzles \\ &(\emph{infinityloop}), Réseaux de neurones, Intelligence Artificielle pour résoudre des jeux(\emph{domineering, sudokus, dominos...})
\end{tabular}
