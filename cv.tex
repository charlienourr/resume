...
\begin{tabular}{ll}
    ...
    \textsc{email:}     & mailto:nourry_charles@outlook.fr%\href{mailto:nourry_charles@outlook.fr}%{nourry_charles$@$outlook.fr}
\end{tabular}
...
\begin{tabular}{r|p{11cm}}
 ...
 \textsc{2016-2017} & Licence Informatique des organisations - MIAGE et Décision \\&\emph{Université Paris-Dauphine, Paris}\\\multicolumn{2}{c}{} \\
 \textsc{2014-2016} & Diplôme d'Etablissement Mathématiques, Informatique et applications à l'Economie et à l'Entreprise (L1 \& L2) \\&\emph{Université Paris-Dauphine, Paris}\\\multicolumn{2}{c}{} \\
 \textsc{2014} & Baccalauréat Scientifique option Mathématiques \\&\emph{Lycée Blanche de Castille, Le Chesnay}\\
\end{tabular}
