...
\begin{tabular}{p{0.06cm} c p{0.04cm}|p{13cm}}
 & \textsc{Début en } & & Thèse : Multiobjective networks design and polyhedra (début en septembre 2019) \\
 & \textsc{septembre 2019} &&\emph{\small{Encadré par Ali Ridha Mahjoub et Hassene Aissi - Université Paris-Dauphine}}\\\multicolumn{2}{c}{} \\
 & \textsc{2018-2019} & & Master 2 Modélisation, Optimisation, Décision et Organisation (Major en M1)\\&&&\emph{\small{Cohabilité par l'Université Paris-Dauphine et Mines ParisTech}}\\\multicolumn{2}{c}{} \\
