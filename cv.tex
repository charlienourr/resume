...
\begin{tabular}{cl}	
 \textsc{Mai} 2018 & Stage de recherche au \textsc{LAMSADE} (Laboratoire d'Analyse et Modélisation de\\ \textsc{Août} 2018 & Systèmes pour l'Aide à la Décision) - Université Paris-Dauphine\\
  & \emph{"Analyse de débats en ligne"} - \small{Etudes et modélisations de débats à l'aide}\\& \small{de la théorie de l'argumentation}\\&\\
 ...
 2016-2018 & Projets universitaires : Gestion d'emplois du temps, Modélisation de problèmes de décisions,\\& Gestion de productions, Résolution de puzzles (\emph{\small{infinityloop}}), Réseaux de neurones, jeux(\emph{\small{domineering, ...}})
\end{tabular}
