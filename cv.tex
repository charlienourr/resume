...
\begin{tabular}{cl}	
 ...
 2016-2018 & Projets universitaires : Gestion d'emplois du temps, Modélisation de problèmes de\\& gestion, Résolution de puzzles (\emph{infinityloop}), Réseaux de neurones, Intelligence Artificiel\\& pour des jeux(\emph{domineering, sudoku, dominos...})
\end{tabular}
