...
\begin{tabular}{cl}	
 ...
 \textsc{Août} 2017 & \emph{"Mise en place d'outils informatique"}\small{, Gestion de bases de données et élaboration d}\\&\\
 2016-2018 & Projets universitaires : Gestion d'emplois du temps, Modélisation de problèmes de gestion,\\& Résolution de puzzles (\emph{\small{infinityloop}}), Réseaux de neurones,\\& Intelligence Artificiel pour des jeux(\emph{\small{domineering, sudoku, dominos...}})
\end{tabular}
...
\textsc{Logiciels/OS} & Microsoft Windows, Linux, Word, Excel, PowerPoint, Access, Eclipse, JetBrains \\&(\emph{IntelliJ, CLion, PyCharm,...}), TeXnicCenter, CPlex Studio, GitHub, Jupyter Notebook, RStudio, MySQL
\end{tabular}
