...
\begin{tabular}{cl}	
 \textsc{Mai} 2018 & Stage de recherche au \textsc{LAMSADE} (Laboratoire d'Analyse et Modélisation de\\ \textsc{Août} 2018 & Systèmes pour l'Aide à la Décision) - Université Paris-Dauphine\\
  & \emph{La théorie de l'argumentation pour analyser les débats en ligne}\\&\\
 ...
 2016-2018 & Projets universitaires : Gestion d'emplois du temps, Résolution de puzzle (\emph{\small{infinityloop}}),\\& Réseaux de neurones, jeux
\end{tabular}
