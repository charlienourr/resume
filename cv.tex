...
\begin{tabular}{cl}	
 \textsc{Avril} 2019 & Stage - chargé de conception de modèles et algorithmes d'optimisation pour réseaux \\ \textsc{Septembre} 2019 & de fibres optiques au sein d’\textsc{Orange Labs Networks}  \\
  & \emph{"Chargé de conception de modèles et algorithmes d'optimisation pour réseaux"}\small{ | Modélisation et optimisation à l'aide d'approches exactes en PLNE}\\
