...
\begin{tabular}{p{0.06cm} c p{0.04cm}|p{13cm}}
 & \textsc{octobre 2019} & & Doctorat en informatique - Université Paris-Dauphine - "The Budgeted Spanning\\
 & \textsc{juin 2025} & & Tree Problem: Extended formulations, Projection, and Branch-and-Cut"\\
 & & & \emph{\small{Encadré par Pr. A. Ridha Mahjoub et Hassène Aissi - LAMSADE}}\\\multicolumn{2}{c}{}\\
 ...
 & \textsc{2014-2017} & & Licence Informatique des organisations - MIAGE et Décision (Major)\\&&&\emph{\small{Université Paris-Dauphine}}\\\multicolumn{2}{c}{} \\
...
\begin{tabular}{c|l}	
\textsc{octobre} 2019 & Enseignement TD/TP à l'Université Paris-Dauphine \\ 
 \textsc{mai} 2024 & \small{Programmation linéaire, Java, Optimisation combinatoire, Algorithmique et programmation,}\\
  & \small{Théorie des graphes, Aide à la décision, Python, Linux.} \\\multicolumn{2}{c}{} \\
 \textsc{avril} 2019 & Stage de fin de Master 2 au sein d’\textsc{Orange Labs Networks} \\ 
 ...
 &\small{Finaliste Prix du mémoire de Master RO/AD de la ROADEF 2019}\\\multicolumn{2}{c}{} \\
 ...
 \textsc{août} 2017 & \emph{"Mise en place d'outils informatiques"}\small{ - Gestion de bases de données et élaboration} \\ &  \small{d'applications}\\\multicolumn{2}{c}{}
 \end{tabular}

\section{Compétences}

\begin{tabular}{l p{15cm}}	
\textsc{Domaines :}    &   Optimisation Combinatoire, Programmation Mathématique, Modélisation, Aide à la décision\\&\\
\textsc{Développement :} & CPLEX, Gurobi, Programmation orientée objet, Java, Julia, C, Python, R, Matlab, \LaTeX, VBA\\&\\
\textsc{Logiciels/OS :}&  Microsoft Windows, Linux, CPLEX  Studio, GitHub, Jupyter Notebook, RStudio, Eclipse, \\
     ...
     \\
\textsc{Langues :}&   Français (Langue maternelle), Anglais (Courant), Espagnol (Occasionnel)
\end{tabular}
